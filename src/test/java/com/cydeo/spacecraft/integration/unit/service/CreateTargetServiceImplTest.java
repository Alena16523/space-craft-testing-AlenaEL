package com.cydeo.spacecraft.integration.unit.service;
...
public class CreateTargetServiceImplTest {
    ...
    public void should_create_targets_with_insane_level() {
        ...
        RuntimeException runtimeException = assertThrows(RuntimeException.class, () ->createTargetService.createTargets(level));
